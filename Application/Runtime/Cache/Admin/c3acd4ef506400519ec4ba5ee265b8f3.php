...
<body style="background-color:#1c77ac; background-image:url(/Public/Admin/images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
    ...
    <div class="loginbody">
        ...
        <div class="loginbox">  
            <ul>
                 ...
                 <li>
                    <input name="" type="button" class="loginbtn" value="登录"  onclick="<?php echo U('Index/main',array('islogin'=>'yes'));?>"  />
    ...
    <div class="loginbm">版权所有  2016  <a href="http://winorange.com">微橙</a> </div>
</body>
